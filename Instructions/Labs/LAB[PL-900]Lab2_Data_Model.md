...
Contoso Consulting would like to use Dataverse to track and manage the events that they host. You need to create the necessary tables to support the future application needs of Contoso.
